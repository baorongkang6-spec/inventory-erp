...
urlpatterns = [
    ...
    path("reports/invoice-quota/", views.invoice_quota_report, name="invoice_quota_report"),
    ...
    path("reports/received-uninvoiced/", views.received_uninvoiced_report, name="received_uninvoiced_report"),
